...
if ( is_home() ) {
	...
	<div id="chic-products"  class="boxed-wrapper clear-fix">
		<h2 class="chic-title">Nos dernières pièces de créateurs</h2>
		<?php
		echo do_shortcode('[products orderby="date" columns="3" order="ASC"]');
		?>
		<p class="text-center"><a class="chic-bouton" href="/shop">Voir notre collection de marques de luxe</a></p>
	</div>
	...
	<div id="chic-fashionweek-map" class="boxed-wrapper clear-fix" style="margin-top:30px">
		<h2 class="chic-title">FashionMap des marques de luxe<br>haute couture - été 2022 </h2>
		<!-- attribution d'un nom au frame pour améliorer accessibilité -->
		<iframe src="https://www.google.com/maps/d/embed?mid=1SU-W19k76UkTXASeT7PnGAyDYCY&hl=en_US&ehbc=2E312F" width="100%" height="480" title="chic-fashionweek-map"></iframe>';
	</div>
	<?php
